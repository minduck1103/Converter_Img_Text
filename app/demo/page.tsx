...
export default function DemoPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto py-8 px-4 md:py-12">
        <div className="space-y-6">
          ...
          <Alert className="bg-blue-50 border-blue-200">
            ...
            <AlertDescription className="text-blue-600">
              Hệ thống sử dụng mô hình Gemini 1.5 Flash của Google để trích xuất văn bản từ hình ảnh với độ chính xác cao
              và tốc độ nhanh.
            </AlertDescription>
          </Alert>
